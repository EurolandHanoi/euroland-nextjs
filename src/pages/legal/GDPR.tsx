                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "16px" }}>
                    {RIGHTS.map((r, j) => (
                      <div key={j} style={{ padding: "16px 24px", border: "1px solid rgb(221, 224, 230)", borderRadius: "4px", borderLeft: "3px solid rgb(0, 116, 217)" }}>
                        <div style={{ fontSize: "var(--fs-base)", fontWeight: 600, color: "rgb(13, 27, 42)", marginBottom: "16px" }}>{r.title}</div>
                        <div style={{ fontSize: "var(--fs-base)", lineHeight: "var(--lh-base)", color: "rgb(58, 74, 88)" }}>{r.desc}</div>
                      </div>
                    ))}
                  </div>
                )}
