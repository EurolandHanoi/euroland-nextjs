  ...
  return (
    <PageWrapper>
      <BannerHero
        ...
        subtitle={t("comms_hero_subtitle", "Distribute regulatory announcements, earnings releases, and investor alerts across every channel, simultaneously and accurately.")}
